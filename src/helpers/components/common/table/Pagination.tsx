...
import { iconCss, containerClassName, pageClassName, activeClassName, pageLinkClassName, previousClassName, previousLinkClassName, nextClassName, nextLinkClassName } from "./TableCss";
