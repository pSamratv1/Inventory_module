...
const commonCss = {
  css: {
    divCss:
      "relative min-w-[17rem] h-[2rem] flex flex-col items-center gap-1 text-[11px] text-dark-100",
...
export const controlBarSearch: any = {
  ...
  css: {
    ...commonCss.css,
    inputCss:
      "z-low w-full h-full pl-6 px-4 rounded-md bg-light-100 border-0 shadow-custom-15",
  },
};
